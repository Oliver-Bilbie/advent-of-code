...
fn read_blocks(input: &str) -> Blocks {
...
fn minimum_distance(blocks: &Blocks) -> Option<u128> {
    ...
    for start_node_id in [
        ...
        for direction in [Direction::Down, Direction::Right] {
            // We can only stop at the end if we hae moved at least four blocks.
            // Thankfully the unit tests caught this, otherwise this would
            // have been painful to debug...
            for direction_count in 4..11 {
