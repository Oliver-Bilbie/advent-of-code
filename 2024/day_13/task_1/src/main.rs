...
fn read_machines(input_file: &str) -> Vec<Machine> {
...
fn main() {
    let machines = read_machines("../input.txt");
...
mod tests {
    ...
    fn it_solves_example_case_1() {
        let machines = read_machines("../test_input.txt");
    ...
    fn it_solves_example() {
        let machines = read_machines("../test_input.txt");
        let actual_cost: u64 = machines
            .iter()
            .filter_map(|machine| solve_machine(machine))
            .map(|solution| solution.get_cost())
            .sum();
        let expected_cost = 480;
