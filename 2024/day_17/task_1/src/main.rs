...
fn read_input(input_file: &str) -> Device {
    let input_str = fs::read_to_string(input_file).unwrap().clone();
...
fn main() {
    ...
    println!("The device output is: {}", output);
}
...
mod tests {
    ...
    fn it_reads_the_input() {
        let actual_input = read_input("../test_input.txt");
    ...
    fn it_solves_the_example() {
        let mut device = read_input("../test_input.txt");
        device.execute_program();
        let actual_output = device.format_output();
